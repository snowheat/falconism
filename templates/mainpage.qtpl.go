...
func (p *MainPage) StreamBody(qw422016 *qt422016.Writer) {
	...
	<div>
		...
		IP: <b>`)
	//line mainpage.qtpl:28
	qw422016.E().S(p.CTX.RemoteIP().String())
	//line mainpage.qtpl:28
	qw422016.N().S(`</b><br/>
		User-Agent: <b>`)
	//line mainpage.qtpl:29
	qw422016.E().Z(p.CTX.UserAgent())
	//line mainpage.qtpl:29
	qw422016.N().S(`</b><br/>
	</div>
`)
//line mainpage.qtpl:31
}
